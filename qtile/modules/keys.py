...
# from qtile_extras.widget.brightnesscontrol import 
...
keys = [
    ...
    Key([mod, "mod1"], "l", lazy.spawn("betterlockscreen --lock blur"), desc="Lock Computer"),
    ...
    # XF86MonBrightnessUp 
    Key([], "XF86MonBrightnessUp", lazy.widget["brightnesscontrol"].brightness_up(), desc="Increase brightness"),
    Key([], "XF86MonBrightnessDown", lazy.widget["brightnesscontrol"].brightness_down(), desc="Decrease brightness"),
    ...
    # KB_GROUP-ScratchPad
    Key(["control"], "1", lazy.group["scratchpad"].dropdown_toggle("term"), desc="PopUp Terminal"),
    Key(["control"], "2", lazy.group['scratchpad'].dropdown_toggle('discord'), desc="Discord"),
    Key(["control"], "3", lazy.group['scratchpad'].dropdown_toggle('files'), desc="PopUp Filemanager"),
    Key(["control"], "4", lazy.group['scratchpad'].dropdown_toggle('calc'), desc="Calculator"),
